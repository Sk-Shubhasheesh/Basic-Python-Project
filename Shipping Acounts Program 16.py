# Hello, In the 16th challenge we create a  Shipping Accounts Program

# Define our list of user
users = ['Jay', 'Sagar', 'Harsh', 'Raj', 'Ram']

print("Welcome to the  Shipping Accounts Program")
# Get user input
username = input("\nHello, what is your username: ").lower().strip()
# User name is in our list
if username in users:
    ...
    bill = quantity*cost
    bill = round(bill, 2)
    print("To ship " + str(quantity) + " items it will be cost you $" + str(bill) + " at $" + str(cost) + " per item.")
    # Place the order if user desire
    choice = input("\nWhat you like to place this order (y/n): ").lower()
    if choice.startswith('y'):
        print("Okay. Shipping your " + str(quantity) + " items.")
    else:
        print("Okay, no order is being shipping at this time.")
